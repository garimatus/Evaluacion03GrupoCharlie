...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/evaluacion03grupocharlie.exe
...
${OBJECTDIR}/dependencias/asignatura.o: dependencias/asignatura.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dependencias/asignatura.o dependencias/asignatura.cpp

${OBJECTDIR}/dependencias/funciones.o: dependencias/funciones.cpp
	${MKDIR} -p ${OBJECTDIR}/dependencias
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dependencias/funciones.o dependencias/funciones.cpp
